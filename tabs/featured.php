                            ...
                            <div class="row borderx" style="padding: 10px;padding-bottom:0;"> 
                                ...
                                <a href="/menu-fullness-cafe"> 
                                  ...
                                  <div class="top10">
                                    <ul class="services-type">
                                      <li>Delivery <i class="fa fa-check"></i></li>
                                    </ul>
                                  </div> 
                                  <div class="top10"> 
                                    <p class="cod-text">Cash on delivery available</p> 
                                  </div> 
                              </div>
                              <div class="col-md-9 borderx"> 
                                ...
                                <p class="merchant-address concat-text">
                                  Sublot 18, Lot 7691, Block 16, Jalan Song, Central land District Kuching, Malaysia Kuching Sarawak 93350
                                </p> 
                                <p class="cuisine bold">Western, Local 
                                </p> 
                                <p>Minimum Order: RM0.00</p> 
                                <p>Delivery Est: 45 MINUTES</p> 
                                <p> Delivery Distance: 30 </p> 
                                <a href="http://localhost/planetkutching/menus" class="orange-button rounded3 medium bottom10 inline-block"> View menu </a> 
                              </div>
                            </div>
                          </div>
